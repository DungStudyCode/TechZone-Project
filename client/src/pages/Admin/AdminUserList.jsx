...
const AdminUserList = () => {
  ...
  // --- HÀM XỬ LÝ KHI BẤM NÚT "GỬI EMAIL NGAY" ---
  ...
  return (
    <div className="p-4 md:p-6 bg-gray-50 min-h-screen font-sans relative">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-gray-800 flex items-center gap-2">
            <FaUserTie className="text-[#724ae8]" /> Quản trị Khách hàng (CRM 360°)
          </h1>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        {loading ? (
          ...
          /* ✅ THÊM: div bọc ngoài để tạo thanh cuộn ngang trên điện thoại */
          <div className="overflow-x-auto w-full">
            {/* ✅ THÊM: min-w-[800px] để bảng không bị ép méo mó */}
                    ...
                    >
                      ...
                      <td className="p-4 text-center">
                        <button
                          ...
                          className="bg-purple-50 text-[#724ae8] border border-purple-200 px-3 py-1.5 rounded-lg text-xs font-bold hover:bg-[#724ae8] hover:text-white transition-colors flex items-center justify-center gap-2 mx-auto whitespace-nowrap"
                        >
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            {/* Header Popup */}
            <div className="bg-[#724ae8] px-4 md:px-6 py-4 flex justify-between items-center text-white shrink-0">
              <h3 className="font-bold text-base md:text-lg flex items-center gap-2 truncate">
                <FaMagic className="shrink-0" /> Cá nhân hóa Email: {selectedUser?.name}
              </h3>
              <button
            ...
            <div className="p-4 md:p-6 flex-1 bg-gray-50 overflow-y-auto">
              ...
              <div className="relative">
                <textarea
                  className="w-full h-48 md:h-64 p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#724ae8] focus:border-transparent resize-none text-sm text-gray-800 leading-relaxed"
                  value={aiContent}
            ...
            {/* Footer Popup */}
            <div className="px-4 md:px-6 py-4 border-t border-gray-100 flex justify-end gap-3 bg-white shrink-0">
              <button
                onClick={() => setShowModal(false)}
              ...
              <button
                ...
                disabled={isGenerating || isSending}
                className="px-4 md:px-6 py-2 bg-[#724ae8] text-white rounded-lg text-sm font-bold hover:bg-purple-700 transition-colors flex items-center justify-center gap-2 disabled:bg-gray-400 disabled:cursor-not-allowed shadow-md"
              >
                {isSending ? (
                  <>
